...
import teer2 from "../assets/images/png/teer2.png";
import teer3 from "../assets/images/png/teer3.png";
import teer4 from "../assets/images/png/teer4.png";
import teer from "../assets/images/png/teer.png";
import line from "../assets/images/png/line.png";
import box1 from "../assets/images/png/box1.png";

const Schritte = () => {
  return (
    <section className="bg_primary py-md-5 position-relative schritte_shadow">
      <img
        className="position-absolute cube_position cube_xl_position_set d-none d-sm-block circle_animation"
        src={box1}
        alt="box1"
      />
      <Container>
        ...
        <Carousel className="d-sm-none z_index_2 position-relative">
          <Carousel.Item>
            <div className="schrittecards d-flex flex-column align-items-center p-3 p-lg-4 h-100 position-relative">
              ...
              <h2 className="ff_montserrat fw_semibold fs_base text_primary  pt-4 schritte_heading">
                1. Terminanfrage
              </h2>
              <p className="common_para opacity_08 text-center mb-0">
          ...
          <Carousel.Item>
            <div className="schrittecards d-flex flex-column align-items-center p-3 p-lg-4 h-100 position-relative">
              ...
              <p className="common_para opacity_08 text-center mb-0">
                ...
                dir einen individuellen Plan, um deinen Markt erobern zu können.
              </p>
            </div>
          </Carousel.Item>
          <Carousel.Item>
            <div className="schrittecards d-flex flex-column align-items-center p-3 p-lg-4 h-100">
              <div className="bg_circle">
                <img src={teer4} alt="teer4" />
              </div>
              <h2 className="ff_montserrat fw_semibold fs_base text_primary  pt-4 schritte_heading">
                4. Die Zusammenarbeit
              </h2>
              <p className="common_para opacity_08 text-center mb-0 ">
                Nach der Beratung zünden wir den Vertriebsturbo und die Schlacht
                beginnt. Wir arbeiten mit dir 1:1 um dir die bestmögliche
                Betreuung zu bieten.
              </p>
            </div>
          </Carousel.Item>
